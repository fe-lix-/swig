...
exports.indent = function(input, numIndent, indentChar) {
  if (numIndent === undefined) {
    numIndent = 4;
  }
  ...
  var out = iterateFilter.apply(exports.indent, arguments);
  if (out !== undefined) {
    return out;
  }

  return Array(numIndent + 1).join(indentChar) + input;  
}
